...
Zur Entwicklung der Strompreise wurden die stündlichen Werte der EPEX [Day-ahead]({{< ref "wissen/markt-energy-only/index.md" >}}) 60-Minuten Auktion für Österreich herangezogen, Zugriff via <https://transparency.entsoe.eu/> [^1]. Für die Ermittlung der Grenzkosten der jeweiligen Kraftwerke wurden die Preise der Rohstoffe näherungsweise bestimmt. Dazu wurden die grafischen Informationen von tradingeconomics.com für Gas[^2], Kohle[^3] und CO<sub>2</sub>[^4] verwertet und die (näherungsweise) tatsächlichen Werte mittels <https://plotdigitizer.com/> extrahiert. Anschließend wurden die Werte auf Tagesbasis interpoliert und in einem weiteren Schritt auf Monatsbasis gemittelt. Die Entwicklung der Brennstoff-, CO<sub>2</sub>- und Strompreise ist in Abbildung 1 dargestellt.
