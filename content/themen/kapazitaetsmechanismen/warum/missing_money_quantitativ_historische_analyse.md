...
werden können. Damit können für über 50% der Simulationen alle erneuerbaren Erzeugungsanlagen ihre Fixkosten decken und es tritt kein "Missing-Money-Problem" auf. PV zeigt die geringste Spannweite (-27  bis 101 k€/MW/a) im Profit, gefolgt von Wind (-94 bis 137 k€/MW/a), während Laufwasserkraft die größte Variation ausweist (2 bis 402 k€/MW/a). Sowohl PV als auch Wind verzeichnen für etwas mehr als 25% der Simulationsläufe Verluste (negativer Profit), wobei Wind hier potenziell ein größeres Problem hat, nachdem die Spannweite der Verluste (bis -94k€/MW/a) deutlich größer ist als bei PV (bis -27k€/MW/a). Für Laufwasserkraft hingegen ist ersichtlich, dass über alle Simulationsläufe hinweg keine Verluste auftreten, diese Technologie somit in 100% der Simulationen genügend Deckungsbeiträge erwirtschaften kann und daher keinem "Missing-Money-Problem" ausgesetzt ist.
