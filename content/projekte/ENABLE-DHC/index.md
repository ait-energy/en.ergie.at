...
Das Projekt trägt dazu bei, nachhaltige und wirtschaftlich tragfähige Fernwärmelösungen zu etablieren und die Umsetzung von Dekarbonisierungsmaßnahmen auf breiter Ebene zu beschleunigen.

## Erkenntnisse

### Entwicklung von Investitionsstrategien für DHC-Systeme

Das Projekt zeigt, dass maßgeschneiderte Investitionspläne entscheidend sind, um bestehende Fernwärme- und Fernkältesysteme effizient zu dekarbonisieren. Durch die Berücksichtigung lokaler Rahmenbedingungen können praktikable und umsetzbare Lösungen entwickelt werden.

### Integration erneuerbarer Energien und Abwärme als Schlüssel

Die Nutzung von erneuerbaren Energiequellen und industrieller Abwärme spielt eine zentrale Rolle für die Transformation von DHC-Systemen. Ihre Integration ermöglicht eine signifikante Reduktion von CO<sub>2</sub>-Emissionen und erhöht gleichzeitig die Versorgungssicherheit.

### Skalierbarkeit durch Fallstudien und Best Practices

Die im Projekt entwickelten Lösungen werden in mehreren Fallstudien getestet und validiert. Dadurch entstehen übertragbare Modelle und Best Practices, die auch in anderen Regionen angewendet werden können.
...
{{< keyword >}}Artikel{{< /keyword >}} [Piani di investimento per un teleriscaldamento efficiente](assets/Publikation_5.pdf), by Riccardo Battisti, 03.12.2024

{{< keyword >}}Artikel{{< /keyword >}} [Il teleriscaldamento di Acqui Terme cerca di decarbonizzarsi](assets/Publikation_4.pdf), by Riccardo Battisti, 02.07.2025
